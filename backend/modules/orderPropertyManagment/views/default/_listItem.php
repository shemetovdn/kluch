...
<td class="center"><?= Html::encode($model->fname)  ?></td>
<td class="center"><?= Html::encode($model->email) ?></td>
...
<td class="center" style="width: 100px;">
    <div class="btn-group btn-actions" aria-label="" role="group" style="width: 100px;">
        <?= \backend\widgets\ChangerStatus::widget([
            ...
            'field' => 'read',
            'id' => $model->id,
            'className' => \backend\modules\orderPropertyManagment\models\OrderPropertyManagment::className(),
            'title' => 'read/unread',
        ]); ?>

        <a <?=\wbp\uniqueOverlay\UniqueOverlay::widget([
            'htmlClass'=>'btn btn-success',
            'url'=>['orderPropertyManagment/default/popup', 'id' => $model->id]
