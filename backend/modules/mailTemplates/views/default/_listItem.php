...
?>
    ...
    <td class="center"><?=Html::encode($model->type->title)?></td>
    <td class="center"><?=Html::encode($model->store->title) ? Html::encode($model->store->title) :  Yii::$app->controller->defaultStoreList[$model->store_id] ?></td>
    <td class="center">
