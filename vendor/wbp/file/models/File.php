...
namespace wbp\file\models;

use wbp\file\ModuleTrait;
use wbp\images\models\SimpleImage;
use Yii;
...
//        $urlSize = ($size) ? '_'.$size : '';
    ...
    public function getLinkToFile($absolute = false){
        $this->checkHtaccess();
        $full_file = $this->getPathToOrigin();
        $full_file = str_ireplace(Yii::getAlias("@serverDocumentRoot"),'',$full_file);
        return $full_file;
    }

    public function checkHtaccess(){
        $base = $this->getModule()->getStorePath().DIRECTORY_SEPARATOR;
        $hta = $base.".htaccess";
        if(!file_exists($hta)){
            file_put_contents($hta,'#autogenerated by files module'."\n".'<Files *.*>'."\n".'   ForceType application/octet-stream'."\n".'   Header set Content-Disposition attachment'."\n".'</Files>'."\n".'RewriteEngine Off');
        }
    }
