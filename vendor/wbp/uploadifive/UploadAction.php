...
class UploadAction extends \yii\base\Action {
    ...
    public function setErrorToInstance($error)
    {
        $this->_uploadFileInstance->error = $error;
    }
...
//        if(!$this->_uploadFileInstance->error){
//            throw new Exception($this->_uploadFileInstance->error, 400);
//        }
    }
