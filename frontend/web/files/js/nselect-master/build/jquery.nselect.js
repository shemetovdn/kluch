...
(function ($) {
    ...
    $.nSelect = function($element, opt) {
        ...
        function init() {
            ...
            function selectBtnClick() {
                ...
                if ($nSelect.hasClass('_active')) {
                    ...
                    if ($('.search-bar').has('.nselect._active')) {
                        $('.search-bar').find('.nselect._active').removeClass('_active');
                    }
        ...
        function changeSelectItem(ctx, item) {
            ...
            // if ($that.find('select').has("select option:selected")){
            //     $that.find("select option:selected").removeAttr('selected');
            //     console.log('sel sel');
            // }
